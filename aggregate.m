...
for j = 1:length(folders)
   ...
   % separate negative an positive ecentrcities 
    ...
    title(['Aggregate n=11: Reaction Time vs. Eccentricity (',COLOR,')']);
    ...
    saveas(gcf, fullfile(fpath, [COLOR,'_aggregate.png']))
    hold on
...
param_table = table(protocol, Right_slope, Right_slope_sd, Left_slope, Left_slope_sd, ...
...
writetable(param_table, fullfile(fpath, 'Aggregate_parameters.xlsx'));
